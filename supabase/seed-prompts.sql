...
피치 구조:
1. 한 줄 요약 (One-Liner): 사업을 한 문장으로 설명
2. 훅 (Hook): 주목을 끄는 한 문장
3. 30초 피치: 엘리베이터 피치 스크립트
4. 2분 피치: 투자자 미팅용 확장 피치 스크립트
5. 핵심 메시지: 반드시 기억해야 할 3가지 메시지
...
## 30초 피치
(엘리베이터 피치 스크립트 - 자연스러운 말하기 형식으로 작성)

## 2분 피치
(투자자 미팅용 확장 피치 스크립트 - 문제, 솔루션, 시장, 차별화, 요청을 포함)
